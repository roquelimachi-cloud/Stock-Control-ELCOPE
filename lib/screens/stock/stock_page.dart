...
class _StockPageState extends State<StockPage> {
  ...
  double get totalStock =>
    lista.fold(0.0, (a, b) => a + b.stock);

double get totalPeso =>
    lista.fold(0.0, (a, b) => a + b.peso);
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: "Buscar código, descripción, cliente, vendedor o lote",
...
//Chip(
 ...
 // label: Text(
 //   "US\$ ${totalValorFacturado.toStringAsFixed(2)}",
  //),
//),
